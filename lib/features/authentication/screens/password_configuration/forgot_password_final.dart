        ...
        child: Padding(
          ...
          child: Column(children: [
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text("FORGOT PASSWORD", style: MFonts.fontAH1),
                  const SizedBox(
                    height: MSizes.md,
                  ),
                  const Text(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              TextButton(onPressed: () => ForgotPasswordController.instance.resendPasswordResetEmail(email), child: const Text("Resend Email")),
            ])
          ]),
        ),
      ),
